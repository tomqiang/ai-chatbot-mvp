...
// UI display config used ONLY by UI (not LLM prompts)
export interface WorldUI {
  storyTitle: string
  questLabel: string
  questText: string
  todaysEventPlaceholder: string
  worldBadge: string
}
...
- 避免：室内场景过多、静态对话、重复性日常活动`,
    ...
    ui: {
      ...
      questLabel: '主线',
      questText: '寻找「月影宝石」',
      todaysEventPlaceholder: '例如：一二在森林中发现了一处古老的遗迹…',
      worldBadge: '中土世界',
    },
  },
  {
...
- 避免：长时间旅行、野外生存、大规模战斗、远离学院的场景`,
    ...
    ui: {
      ...
      questLabel: '主线',
      questText: '追索学院秘闻',
      todaysEventPlaceholder: '例如：他们在宵禁后靠近禁区走廊，听见封印传来断续的低语…',
      worldBadge: '魔法学院',
    },
  },
  {
...
- 避免：长时间静态对话、大规模战斗、远离系统核心的场景`,
    ...
    ui: {
      ...
      questLabel: '主线',
      questText: '追查异常信号',
      todaysEventPlaceholder: '例如：他们在维护通道前发现安全闸门封锁，另一侧传来断续的异常信号…',
      worldBadge: '未来城市',
    },
  },
]
...
export const DEFAULT_WORLD_UI: WorldUI = {
  storyTitle: '月影纪事',
  questLabel: '主线',
  questText: '寻找「月影宝石」',
  todaysEventPlaceholder: '例如：一二在森林中发现了一处古老的遗迹…',
